    ...
    <BrowserRouter>
      <Suspense fallback={<Spinner />}>
        ...
        <Routes>
          ...
          <Route path="/log" element={<Log name="wishlist" />} />
          <Route path="/log" element={<Log name="orders" />} />
          <Route path="/log" element={<Log name="settings" />} />
          <Route path="/log" element={<Log name="address" />} />
