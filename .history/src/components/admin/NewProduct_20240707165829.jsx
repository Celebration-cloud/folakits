        ...
        <section className={styles.formInput}>
          <div className={styles.part1}>
            <TextField
              id="outlined-basic"
              label="Name"
              {...register("name", { required: error.name.required, maxLength: error.name.maxLength.value, maxLength: error.name.maxLength.value })}
              fullWidth
              error={errors.name}
              variant="outlined"
              helperText={() =>
                {
                  return (
                    ...
                    error.name.maxLength.value && (
                      <p role="alert">{error.name.maxLength.message}</p>
                    ),
                    error.name.minLength.value && (
                      <p role="alert">{error.name.maxLength.message}</p>
                    )
                  );}
              }
