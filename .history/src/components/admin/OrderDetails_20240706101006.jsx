        ...
        <div className="p-6 bg-card text-card-foreground rounded-lg shadow-md">
          <div className="flex justify-between items-center mb-4">
            <button className="text-primary hover:text-primary-foreground">
              <img undefinedhidden="true" alt="back-arrow" src="https://openui.fly.dev/openui/24x24.svg?text=⬅️" />
            </button>
            <div className="flex space-x-4">
              <button className="bg-primary text-primary-foreground py-2 px-4 rounded-lg hover:bg-primary/80">Edit Invoice</button>
              <button className="bg-accent text-accent-foreground py-2 px-4 rounded-lg hover:bg-accent/80">Print Invoice</button>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <div className="text-right">
              <p className="font-bold">Order Status: <span className="text-muted-foreground">Pending</span></p>
              <p className="font-bold">Order Date: <span className="text-muted-foreground">July 06, 2024</span></p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
          ...
          <div className="flex justify-end">
            <div className="text-right">
              <p className="font-bold">Sub Total: <span className="text-muted-foreground">$6300</span></p>
              <p className="font-bold">Vat(%): <span className="text-muted-foreground">10</span></p>
              <p className="font-bold">Grand Total: <span className="text-muted-foreground">$6930</span></p>
            </div>
          </div>
        </div>
    )
