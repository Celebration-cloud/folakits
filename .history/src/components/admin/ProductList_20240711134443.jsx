...
import { Box, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, styled } from "@mui/material";
...
export default function ProductList() {
  ...
  async function handleDelete(id, product) {
    try {
      const storageRef = ref(storage, `products/${product}`);
    ...
    setDataSet((prev) => prev.filter((item) => {
      return item.id !== id 
    }));
  ...
  return (
    <div className={styles.productListContainer}>
      ...
      >
        ...
        <DialogActions>
          <Butto onClick={handleClose}>Disagree</Butto>
