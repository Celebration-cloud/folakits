...
const closedMixin = (theme) => ({
  ...
  overflowX: 'hidden',
  width: menuWidth < 500 ? `calc(${theme.spacing(0)} + 1px)` :  ` calc(${theme.spacing(8)} + 5px)`,
...
export default function AdminDashboardNav() {
  ...
  return (
    <Box sx={{ display: "flex" }}>
      <CssBaseline />
      <AppBar position="static" style={{zIndex: "-1px", top: "0px", height: "100%", position: "absolute"}} open={open}>
        <Toolbar>
          <IconButton
            color="inherit"
