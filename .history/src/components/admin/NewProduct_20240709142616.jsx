...
function NewProduct() {
    ...
    (data) => {
      ...
      listAll(storageRef)
        ...
        .then(() => {
          ...
          toaster.success("successfully rendered");
          console.log(res);
        })
        .catch((error) => {
  ...
  useEffect(() => {
    window.addEventListener("submit", retrieve)
    return () => {
      window.removeEventListener("submit", retrieve)
    }
  }, [retrieve])
