...
const primaryButtonClass = 'bg-primary text-primary-foreground py-2 px-4 rounded-lg hover:bg-primary/80'
const accentButtonClass = 'bg-accent text-accent-foreground py-2 px-4 rounded-lg hover:bg-accent/80'
    ...
    <div className="p-6 bg-card text-card-foreground rounded-lg shadow-md">
      <div className="flex justify-between items-center mb-4">
        <button className={buttonClass}>
          <img aria-hidden="true" alt="back-arrow" src="https://openui.fly.dev/openui/24x24.svg?text=⬅️" />
        </button>
