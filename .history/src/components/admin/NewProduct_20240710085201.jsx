...
import onSubmit from '../../../server/firebase/NewProductServerside';
function NewProduct() {
  ...
  useEffect(() => {
    if (isSubmitSuccessful) {
      reset({ name: "", description: "", category: "", brand: "",price: 0, quantity: 0 });
    }
  ...
  return (
    <div className={styles.container}>
      ...
      <hr />
      <form
        onSubmit={handleSubmit((data) => onSubmit(data, files, setImages))}
