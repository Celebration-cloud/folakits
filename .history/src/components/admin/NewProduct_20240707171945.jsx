...
function NewProduct() {
  ...
  const error = {
    ...
    price: {
      ...
      minLength: {
        value: 3,
        message: "Price must be at least 3 e long",
      },
      maxLength: {
        value: 20,
        message: "Price must be at most 20 e long",
      },
    },
    quantity: {
      ...
      minLength: {
        value: 3,
        message: "quantity must be at least 3 e long",
      },
      maxLength: {
        value: 20,
        message: "quantity must be at most 20 e long",
      },
    },
