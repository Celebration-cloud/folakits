...
function FirstContent() {
  const categories = [
    { id: 1, name: `Men's Clothes`, img: img1 },
    { id: 2, name: `Women's clothes`, img: img2 },
    { id: 3, name: 'Jewelries', img: img3 },
    { id: 4, name: 'Shoes', img: img3 },
  ]
  return (
    <div className={styles["first-content"]}>
      ...
      <article className={styles["collection"]}>
        {categories.map((iten) => (
          <section key={ListItem.} className="bg-card p-4 rounded-lg shadow-md flex items-center space-x-4">
