    ...
    const [isHovered, setIsHovered] = useState(false);
     ...
     const handleClose = () => {
      ...
      const imageStyle = {
        ...
        opacity: product.price > 0 ? (product.img[1] && isHovered ? 0 : 1) : 0.3,
      };
     const hoverImageStyle = {
       ...
       top: 0,
       left: 0,
       opacity: product.price > 0 && product.img[1] && isHovered ? 1 : 0,
     };
  ...
  return (
    ...
    >
      ...
      <div style={iconStyle}>
        ...
        <Tooltip title="Preview" onClick={handleClickOpen} placement="left-end">
          <i
            style={{
              backgroundColor: "white",
              padding: "6px",
