    ...
    return (
      <div className={styles.categories}>
        ...
        <div className={styles.outlet}>
          <Link to="/log" onClick={() => {navigate("/log"), window.location.reload()}} style={{color: "black"}}><i className="fa-solid fa-right-to-bracket"></i></Link>
          <Link to="/log/wishlist" style={{color: "black"}}><WishList /></Link>
          <Link to="/cart" style={{color: "black"}}><CartBadge /></Link>
