          ...
          >
            <div className={styles["carousel-inner"]}>
              ...
              <div className={styles["carousel-item active"]}>
                <img src="https://i.imgur.com/bV1xmG5.jpg" className={styles["rounded" ]}/>
              </div>{" "}
              <div className={styles["carousel-item"]}>
                <img src="https://i.imgur.com/vgMi4nw.jpg" className={styles["rounded" ]}/>
              </div>{" "}
              <div className={styles["carousel-item"]}>
                <img src="https://i.imgur.com/hRlGe10.jpg" className={styles["rounded" ]}/>
              </div>
            </div>
            <ol className={styles["carousel-indicators list-inline"]}>
              <li className={styles["list-inline-item active"]}>
                <a
                  id={sy["carousel-selector-0"]}
