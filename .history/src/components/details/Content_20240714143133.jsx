...
console.log(products, name, item.current.product)
  ...
  return (
    <div className={styles.content}>
      <div className={styles.image}>
        <CarouselImage image={item.current?.img}/>
      </div>

      <div className={styles.info}>
        <h3 className={styles.title}>{item.current?.product}</h3>
        <span className={styles.price}>{item.current?.price}</span>
