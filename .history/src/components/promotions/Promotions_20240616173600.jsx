...
function Promotions() {
  ...
  if(width < 780) {
    sections = { display: "inline-flex", justifyContent: "space-around", flexWrap: "wrap" };
  }else {
    sections = { display: "flex", justifyContent: "space-around" };
  }
  if(width > 426) {
    ...
    promotionContainerStyle = {...promotionContainerStyle, padding: "10px", justifyContent: "space-between"}
  }
  ...
  return (
    <div style={promotionContainerStyle}>
      <div style={{ display: "inline-flex", justifyContent: "space-between", gap: "40px" }}>
        <h6>Promotion</h6>
