...
let sections;
let promotionContainerStyle = (promotionContainerStyle = {
  display: "inline-flex",
...
function Promotions() {
  ...
  if(width < 780) {
    sections = { display: "inline-flex", justifyContent: "space-around", flexWrap: "wrap", gap: "10px" };
  }else {
    sections = { display: "inline-flex", justifyContent: "space-around" };
  }
  if(width > 426) {
    promotionContainerStyle = promotionContainerStyle
  }else{
