...
const CartTotals = ({ subtotal, shipping }) => {
  ...
  return (
    <div className={styles.cartTotals}>
      ...
      <div class="flex justify-between items-center border-b border-border py-2">
        <div class="flex items-center space-x-2">
          <span class="text-foreground font-semibold">BeHeadphones</span>
          <span class="bg-muted text-muted-foreground text-xs px-2 py-1 rounded-full">
            × 4
          </span>
        </div>
        <span class="text-foreground">$343.60</span>
      </div>
      <div class="flex justify-between items-center py-2">
        <div class="flex items-center space-x-2">
          <span class="text-foreground font-semibold">BeSmartphone3</span>
          <span class="bg-muted text-muted-foreground text-xs px-2 py-1 rounded-full">
            × 1
          </span>
        </div>
        <span class="text-foreground">$250.00</span>
      </div>
