    ...
    <>
      ...
      {cart < 1 && (
        <div class="flex flex-col items-center justify-center h-screen bg-background">
          ...
          />
          <p class="text-primary-foreground text-lg font-semibold">
            Your cart is empty
          </p>
          <p class="text-secondary-foreground mt-2">
            Start shopping to add items to your cart!
          </p>
          <button class="mt-4 px-6 py-2 bg-accent text-accent-foreground rounded-md hover:bg-accent/80 transition">
            Shop Now
          </button>
        </div>
      )}
