...
function Footer() {
  ...
  if(width < 600){
    sections = { display: "flex", width: "100%", gap: "40px", flexWrap: "wrap" };
  }else{
    sections = { display: "flex", width: "100%", gap: "40px" };
  }
  const footerStyle = {
    backgroundColor: "white",
    color: "#ffffff",
    textAlign: "left",
    padding: width < 426 ? "20px 10px 10px 10px":"40px",
    left: "0",
    bottom: "0",
    width: "100%",
  };
  ...
  return (
    <footer style={footerStyle}>
      ...
      <div style={{ ...sectionStyle, textAlign: "center", marginBottom: "0px",  }}>
        <span>
          © {new Date().getFullYear()} Folakits. All rights
          reserved.
        </span>
      </div>
    </footer>
