                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      {...register("password", {required: error.password.required, minLength: error.password.minLength})}
                      className="flex h-10 w-full rounded-md border border-gray-300 bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                      name="password"
                    />
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      type="file"
                      aria-invalid={errors.prof ? "true" : "false"}
                      {...register("profile_picture", {required: error.picture.required, defaultrequired})}
                      name="avatar"
                    />
                    {errors.profile_picture && <p role="alert">{errors.mail?.message}</p>}
                  </div>
                </div>
                <div>
                  <button
