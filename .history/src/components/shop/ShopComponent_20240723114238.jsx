...
import { getCategoryItems, getItemOrders, searchItem } from "../../store/actions/quoteActions";
...
function ShopComponent() {
 ...
 switch (sortType) {
  ...
  console.log(products, wishlistRef.current, cartListRef.current)
    useEffect(() => {
      window.scrollTo(0, 0);
    }, [dispatch]);
  ...
  const currentItems = f?.slice(startIndex, endIndex);
