      ...
      <ul className={styles.categories}>
        <li className={styles.category}>
          <img
            ...
            className="w-6 h-6"
          />
          <span className="btn-close text-reset"
              data-bs-dismiss="offcanvas"
              aria-label="Close" onClick={() => {dispatch(getCategoryItems("Men Clothes")), navigate(`/${'Men Clothes'}`)}} className="text-secondary-foreground">Men Clothes</span>
        </li>
        <li className={styles.category}>
          <img
            src={img2}
