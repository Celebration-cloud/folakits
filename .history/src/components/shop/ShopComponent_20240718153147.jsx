...
import { getUerItem, userWishlist } from "../../store/actions/userActions";
...
function ShopComponent() {
  ...
  const [wishlistItem, setProductItem] = useState(userData)
  ...
  console.log( products, userWishlist-Item), 
  useEffect(() => {
    window.scrollTo(0, 0);
