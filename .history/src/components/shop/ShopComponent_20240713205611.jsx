...
function ShopComponent() {
   ...
   const [filteredProducts, setFilteredProducts] = useState(rest.current);
   console.log(sortType, filteredProducts, rest);
  ...
  const sortProducts = (type) => {
    ...
    rest.current = sortProducts
    setFilteredProducts(sortedProducts);
    setSortType(type);
  };

  const totalPages = Math.ceil(re.length / itemsPerPage);
