    ...
    <div className={styles.container}>
      ...
      <div className={styles.sortingSection}>
        <div className={styles.sort}>
          ...
          <InputLabel id="demo-simple-select-label">De</InputLabel>
          <Select
          ...
          >
            <MenuItem value="latest">Ten</MenuItem>
            <MenuItem value="priceLowHigh">Twenty</MenuItem>
            <MenuItem value="priceHighLow">Thirty</MenuItem>
          </Select>
