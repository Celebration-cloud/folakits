...
const Billing = () => {
  ...
  const [shippingInfo, setShippingInfo] = useState({
    ...
    address: userData && userData[0]?.address.address,
    city: userData && userData[0]?.address.city,
    postalCode: userData && userData[0]?.address.postalCode,
    country: userData && userData[0]?.address.country,
  });
