  ...
  const fet = useCallback(
    async() => {
      ...
      const unsubscribe = onSnapshot(userCollectionRef, (querySnapshot) => {
        ...
        dispatch({ type: ActionTypes.GET_CART, payload: newData?.cart ? newData?.cart : []  });
        dispatch({ type: ActionTypes.GET_WISHLIST, payload: newData?.WishList ? newData?.WishList : [] });
        dispatch({ type: ActionTypes.GET_ADDRESS, payload: newData?.address ? newData?.address : []});
        dispatch({ type: ActionTypes.GET_ORDERS, payload: newData?.orders ? newData?.orders : [] });
