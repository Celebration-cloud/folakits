...
const UserDashboard = ({name}) => {
  ...
  const products = [
    ...
    },
    {
      name: "Bear boots",
      img: [img3],
      description: 'Morbi vitae sem. Suspendisse ac augue varius nunc ac turpis libero, consectetuer tincidunt, mi mauris, consectetuer lectus. Aenean bibendum. In lacinia eget, pede. Cras tempus erat. Sed sollicitudin posuere, nibh faucibus quis, ipsum.',
      price: "$25.00",
      originalPrice: "$28.00",
      onSale: true,
    },
