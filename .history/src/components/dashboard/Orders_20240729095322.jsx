    ...
    <div>
      ...
      {filteredOrders.map((order, index) => (
        ...
        >
          ...
          <p style={order.status === "Approved" ? {backgroundColor: "green"} : order.status === "Cancelled" ? {backgroundColor: "red" } : {backgroundColor: "yellow", color: "white"}}>Status: {order.status}</p>
