...
export const userWishlist= (userData, username, wishlist) => async (dispatch, getState) => {
  console.log(username, userData, wishlist)
  const updateRef = doc(db, "users", username);
    try {
      if(!wishlist){
        await updateDoc(updateRef, {
          wishlist: arrayUnion(userData),
        });
      }else{
        await updateDoc(updateRef, {
          wishlist: arrayRemove(userData),
          });
      }
